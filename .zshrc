...
plugins=(git bgnotify zsh-syntax-highlighting virtualenvwrapper sublime httpie vagrant gulp)
...
#
# Example aliases
alias zshconfig="sudo sublime ~/.zshrc"
alias ohmyzsh="sudo sublime ~/.oh-my-zsh"
